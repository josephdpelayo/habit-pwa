...
const CACHE_VERSION = '20260822-21'; // keep in sync with APP_VERSION in app.html
...
const SHELL = ['/app.html', '/skandi.html', `/skandi-recovery.js?v=${CACHE_VERSION}`, `/body-figure.js?v=${CACHE_VERSION}`, `/skandi-nutrition.js?v=${CACHE_VERSION}`, `/skandi-load.js?v=${CACHE_VERSION}`];
